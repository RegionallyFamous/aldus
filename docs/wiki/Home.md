...
Aldus is a single WordPress block that composes your content into a fully-laid-out page — using sixteen named layout personalities and a tiny AI model that runs entirely in your browser.
