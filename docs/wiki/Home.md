...
Aldus is a single WordPress block that composes your content into a fully-laid-out page — using its library of named layout personalities and a tiny AI model that runs entirely in your browser.

You bring the words, images, and links. Aldus figures out how to arrange them.
...
**How do I install it?** See [Getting Started](Getting-Started).
