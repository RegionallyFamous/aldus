...
- **WordPress 6.4 or later** — Aldus uses the block editor exclusively
...
> If your browser does not support WebGPU, Aldus will still work — you can use the [Sample Packs](Sample-Packs) to preview all layout styles without the model, and the plugin will tell you exactly which browser to switch to.
...
- For common content structures, click one of the **Quick Start preset** text links (Blog post · Landing page · Feature story · Product pitch · Portfolio · Tutorial · Comparison) that appear in the empty state. The preset fills in the content types automatically — you then fill in your actual text and images.
...
Once the model is ready, Aldus generates a proposed layout for each personality simultaneously.

### Step 3: Choose a layout

The results screen shows one card per personality. Each card displays:
...
2. Choose one of the nine themed packs (Roast, Meridian, Hearth, Plume, Grove, Loot, Signal, Forge, Slim)
